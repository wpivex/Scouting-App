...
const colorGuide = ["#f1f1f1", "red", "blue"];
...
$(function () {
    ...
    canvas = document.getElementById("endState");
...
function changeVal(element) {
    ...
    } else if (element.classList.contains("fr")) {
        document.getElementById("finalRed").value = +document.getElementById("finalRed").value + change;
    } else if (element.classList.contains("fb")) {
        document.getElementById("finalBlue").value = +document.getElementById("finalBlue").value + change;
    }
}
...
function clearForm() {
    ...
    document.getElementById('finalRed').value = 0;
    document.getElementById('finalBlue').value = 0;
    lineColors = [0, 0, 0, 0, 0, 0, 0, 0];
